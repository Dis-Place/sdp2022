...
sealed class GameEvent{
    data class OnPointSelected(val test : Coordinate) : GameEvent() //Try of one of the player
    data class OnStart(val Goal : Coordinate, val Photo: Int, val PlayerId: Int) : GameEvent()
